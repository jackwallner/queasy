...
For each Queasy subscription: take its existing USA price point, fetch that
...
USA_PRICES = {
    "com.jackwallner.queasy.pro.monthly": "4.99",
    "com.jackwallner.queasy.pro.yearly": "29.99",
}
