...
/// On-device record of how someone met Queasy Pro before they bought it: which
...
enum ConversionDiagnostics {
    private static let logger = Logger(subsystem: "com.jackwallner.queasy", category: "Conversion")
    ...
    static let suiteName = "group.com.jackwallner.queasy"
    ...
    private static let impressionPrefix = "queasy_"
